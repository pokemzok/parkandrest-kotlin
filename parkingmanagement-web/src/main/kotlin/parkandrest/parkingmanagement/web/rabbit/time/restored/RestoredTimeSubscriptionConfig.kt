...
import parkandrest.parkingmanagement.web.rabbit.time.changed.ChangedTimeEventConsumer


@Configuration
class RestoredTimeSubscriptionConfig (
        @Value("\${parkingmanagement.restored-time.queue}") private val queueName: String
) {
